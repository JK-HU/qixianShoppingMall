...
window.Dom7 = function () {
                    ...
                    for (h = 0; h < d.length; h += 1) {
                        ...
                        if ("plain" !== f.type) {
                            ...
                            if ("variable" === f.type && (g = a(f.contextName, c, m), u += "r += c(" + g + ", " + c + ");"), "helper" === f.type) {
                                ...
                                if (f.helperName in i.helpers) v = t(f.contextName, c, m), u += "r += (Template7.helpers." + f.helperName + ").call(" + c + ", " + (v && v + ", ") + "{hash:" + JSON.stringify(f.hash) + ", data: " + m + " || {}, fn: " + o(f, s + 1) + ", inverse: " + p(f, s + 1) + ", root: root, parents: " + b + "});";
                                else {
    ...
    function () {
        ...
        window.Framework7 = function (e) {
                ...
                if (o.handleTouchStart = function (e) {
                        ...
                        if (E) {
                            ...
                            if (!O) {
                                ...
                                p.length > 0 && (!r.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), r.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), D = s.is(".page") ? s : s.parents(".page"), D.hasClass("no-swipeback") && (n = !0), z = l.find(".page-on-left:not(.cached)");
                                var d = L.x - l.offset().left > o.params.swipeBackPageActiveArea;
                                if (d = r.rtl ? L.x < l.offset().left - l[0].scrollLeft + b - o.params.swipeBackPageActiveArea : L.x - l.offset().left > o.params.swipeBackPageActiveArea, d && (n = !0), 0 !== z.length && 0 !== D.length || (n = !0), n) return void(E = !1);
                            ...
                            var c = r.rtl ? -1 : 1;
                            w = (a - L.x - o.params.swipeBackPageThreshold) * c, w < 0 && (w = 0);
                            var m = w / b,
                                u = {
                                    percentage: m,
                                    activePage: D[0],
                            ...
                            var h = w * c,
                                f = (w / 5 - b / 5) * c;
                            if (1 === r.device.pixelRatio && (h = Math.round(h), f = Math.round(f)), D.transform("translate3d(" + h + "px,0,0)"), o.params.swipeBackPageAnimateShadow && !r.device.android && (S[0].style.opacity = 1 - 1 * m), z.transform("translate3d(" + f + "px,0,0)"), o.params.swipeBackPageAnimateOpacity && (M[0].style.opacity = 1 - 1 * m), P) {
                                var g;
                        ...
                        if (E = !1, O = !1, 0 === w) return i([D[0], z[0]]).transform(""), void(P && (y.transform("").css({
                            opacity: ""
                        }), x.transform("").css({
                            opacity: ""
                        ...
                        var a = (new Date).getTime() - C,
                            t = !1;
                        (a < 300 && w > 10 || a >= 300 && w > b / 2) && (D.removeClass("page-on-center").addClass("page-on-right"), z.removeClass("page-on-left").addClass("page-on-center"), P && (N.removeClass("navbar-on-center").addClass("navbar-on-right"), A.removeClass("navbar-on-left").addClass("navbar-on-center")), t = !0), i([D[0], z[0]]).transform("").addClass("page-transitioning"), P && (y.css({
                            opacity: ""
                        }).each(function () {
                        ...
                        D.transitionEnd(function () {
                            i([D[0], z[0]]).removeClass("page-transitioning"), P && (y.removeClass("page-transitioning").css({
                                opacity: ""
                                ...
                                oldPage: D,
                                swipeBack: !0
                            }), r.router.afterBack(o, D, z), o.params.onSwipeBackAfterChange && o.params.onSwipeBackAfterChange(n), l.trigger("swipeBackAfterChange swipeback:afterchange", n)) : (o.params.onSwipeBackAfterReset && o.params.onSwipeBackAfterReset(n), l.trigger("swipeBackAfterReset swipeback:afterreset", n)), S && S.length > 0 && S.remove(), M && M.length > 0 && M.remove()
                        })
            ...
            var l = function (e, a) {
                ...
                return o.search = function (e, a) {
                    ...
                    var a = e ? "off" : "on";
                    o.container[a]("submit", t), o.material || o.cancelButton[a]("click", o.disable),
                        o.overlay[a]("click", o.disable), o.input[a]("focus", o.enable), o.input[a]("change keydown keypress keyup compositionend", o.handleInput), o.clearButton[a]("click", o.clear)
                }, o.detachEvents = function () {
                    o.attachEvents(!0)
                }, o.init = function () {
                    o.attachEvents()
            ...
            r.triggerPageCallbacks = function (e, a, t) {
                ...
                else i(r.router.temporaryDom).append(f);
                if (u = a.reload && (a.reloadPrevious ? "left" : "center"), !(n = b ? C.find('.page[data-page="' + b + '"]') : k ? i(k) : r.router.findElement(".page", r.router.temporaryDom, e)) || 0 === n.length || b && e.activePage && e.activePage.name === b) return void(e.allowPageChange = !0);
                ...
                if (e.params.uniqueHistory) {
                    ...
                    if (e.params.uniqueHistoryIgnoreGetParameters)
                        for (L = [], D = h.split("?")[0], l = 0; l < e.history.length; l++) L.push(e.history[l].split("?")[0]);
                    L.indexOf(D) !== L.lastIndexOf(D) && (e.history = e.history.slice(0, L.indexOf(D)), e.history.push(h), O = !0)
                }
                ...
                m && y && r.router.prepareNavbar(d, p, "right");
                n[0].clientLeft;
                ...
                if (a = a || {}, r.routerPreOptions && (a = r.routerPreOptions(e, a) || {}), a.component && r.componentLoader) try {
                    ...
                    if (i(e.pagesContainer).find(".page:not(.cached)").length > 1 && !p) return void r.router._back(e, a);
                    if (p) {
            ...
            r.modalStack = [], r.modalStackClearQueue = function () {
                ...
                i(".preloader-indicator-overlay").length > 0 || r.root.append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-white">' + (r.params.material ? r.params.materialPreloaderHtml : "") + "</span></div>")
                ...
                if (!0 !== e.data("f7-modal-shown")) {
                    ...
                    var m;
                    o || l || (0 !== i(".modal-overlay").length || s || r.root.append('<div class="modal-overlay"></div>'), 0 === i(".popup-overlay").length && s && r.root.append('<div class="popup-overlay"></div>'), m = i(s ? ".popup-overlay" : ".modal-overlay")), r.params.material && l && e.hasClass("picker-calendar") && (0 !== i(".picker-modal-overlay").length || s || r.root.append('<div class="picker-modal-overlay"></div>'), m = i(".picker-modal-overlay")), m && m[a ? "removeClass" : "addClass"]("not-animated");
                    e[0].clientLeft;
                    return e.trigger("open " + d + ":open"), l && i("body").addClass("with-picker-modal"), e.find("." + r.params.viewClass).length > 0 && (e.find(".page").each(function () {
                ...
                if (e = i(e || r.root), 0 !== e.length) {
                    ...
                    if (n = e.hasClass("progressbar") ? e : e.children(".progressbar"), 0 !== n.length && !n.hasClass("progressbar-infinite")) {
                        n[0].clientLeft;
                        return n.children("span").transform("translate3d(" + (-100 + a) + "%,0,0)"), void 0 !== t ? n.children("span").transition(t) : n.children("span").transition(""), n[0]
                    }
                }
                ...
                function a(e) {
                    if (o && !e.f7PreventPanelSwipe) {
                        ...
                        if (r.params.swipePanelNoFollow) {
                            return (new Date).getTime() - d < 300 && ("to-left" === v && ("right" === s && r.openPanel(s), "left" === s && n.hasClass("active") && r.closePanel()), "to-right" === v && ("left" === s && r.openPanel(s), "right" === s && n.hasClass("active") && r.closePanel())), o = !1, void(l = !1)
                        }
            ...
            r.messages = function (e, a) {
                ...
                function t(e) {
                    if (s) {
                        ...
                        var L;
                        if (u.length > 0)
                            for (O = v / g, v < -g && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (S = !0)), n = 0; n < y.length; n++) void 0 === y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, L = i(y[n]), k.length > 0 && L.hasClass("swipeout-overswipe") && (L.css({
                                left: (S ? -p : 0) + "px"
                        ...
                        if (h.length > 0)
                            for (O = v / f, v > f && (v = f + Math.pow(v - f, .8), T.length > 0 && (P = !0)), n = 0; n < C.length; n++) void 0 === C[n]._buttonOffset && (C[n]._buttonOffset = f - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, L = i(C[n]),
                ...
                if (e = i(e), 0 !== e.length) {
                    ...
                    if (0 !== p.length) {
                        ...
                        if (!(T.disabled || e.hasClass("disabled") || k.hasClass("disabled"))) {
                            ...
                            var X = r._compiledTemplates.smartSelectItem,
                                G = "";
                            if (!w)
                                for (var j = 0; j < H.length; j++) G += X(H[j]);
                            var _, U, J = "",
                                Q = "",
                                K = "",
                                Z = "";
                            "picker" === d ? (r._compiledTemplates.smartSelectToolbar || (r._compiledTemplates.smartSelectToolbar = s.compile(r.params.smartSelectToolbarTemplate || '<div class="toolbar {{#if toolbarTheme}}theme-{{toolbarTheme}}{{/if}}"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker"><span>{{closeText}}</span></a></div></div></div>')), J = r._compiledTemplates.smartSelectToolbar({
                                ...
                                inPopup: "popup" === d,
                                inPage: "page" === d,
                                leftTemplate: "popup" === d ? (r.params.smartSelectPopupCloseTemplate || (y ? '<div class="left"><a href="#" class="link close-popup icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left"><a href="#" class="link close-popup"><i class="icon icon-back"></i><span>{{closeText}}</span></a></div>')).replace(/{{closeText}}/g, c) : (r.params.smartSelectBackTemplate || (y ? '<div class="left"><a href="#" class="back link icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left sliding"><a href="#" class="back link"><i class="icon icon-back"></i><span>{{backText}}</span></a></div>')).replace(/{{backText}}/g, h)
                            ...
                            var re, ne, ie = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + R + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + $ + '"><a href="#" class="searchbar-clear"></a></div>' + (y ? "" : '<a href="#" class="searchbar-cancel">' + ee + "</a>") + '</form><div class="searchbar-overlay"></div>',
                                se = ("picker" !== d && "through" === U ? _ : "") + '<div class="pages">  <div data-page="' + ae + '" data-select-name="' + F + '" class="page smart-select-page ' + Q + " " + K + " " + Z + '">' + ("picker" !== d && "fixed" === U ? _ : "") + (te ? ie : "") + '    <div class="page-content">' + ("picker" !== d && "static" === U ? _ : "") + '      <div class="list-block ' + (w ? "virtual-list" : "") + " smart-select-list-" + R + " " + (g ? "theme-" + g : "") + '">        <ul>' + (w ? "" : G) + "        </ul>      </div>    </div>  </div></div>";
            ...
            r.virtualList = function (e, a) {
                ...
                function t(e) {
                    if (d) {
                        ...
                        if (a && t) {
                            ...
                            "ios" === r.device.os && parseInt(r.device.osVersion.split(".")[0], 10) > 7 && 0 === v && !b && (k = !0), k && (e.preventDefault(), g = Math.pow(u, .85) + P, f.transform("translate3d(0," + g + "px,0)")), k && Math.pow(u, .85) > w || !k && u >= 2 * w ? (T = !0, f.addClass("pull-up").removeClass("pull-down")) : (T = !1, f.removeClass("pull-up").addClass("pull-down")), y || (f.trigger("pullstart ptr:pullstart"), y = !0), f.trigger("pullmove ptr:pullmove", {
                                event: e,
                                scrollTop: v,
                                translate: g,
                                touchesDiff: u
                ...
                e = i(e);
                var t = e.find(".tabbar");
                0 === t.length && e.hasClass("tabbar") && (t = e), t.length > 0 && (0 === t.find(".tab-link-highlight").length && t.find(".toolbar-inner").append('<span class="tab-link-highlight"></span>'), a(), r.onResize(a), e.once("page:beforeremove", function () {
                    r.offResize(a)
                }))
                ...
                function f(e, a, t) {
                    if (t) {
                        ...
                        q = i('<div class="ripple-wave" style="width: ' + l + "px; height: " + l + "px; margin-top:-" + l / 2 + "px; margin-left:-" + l / 2 + "px; left:" + n.x + "px; top:" + n.y + 'px;"></div>'), t.prepend(q);
                        q[0].clientLeft;
                        W = "translate3d(" + (o / 2 - n.x) + "px, " + (s / 2 - n.y) + "px, 0) scale(1)", q.transform(W)
                    }
                }
                ...
                function g() {
                    if (q) {
                        ...
                        q.addClass("ripple-wave-fill").transform(W.replace("scale(1)", "scale(1.01)")).transitionEnd(function () {
                            clearTimeout(a);
                            var e = i(this).addClass("ripple-wave-out").transform(W.replace("scale(1)", "scale(1.01)"));
                            a = setTimeout(function () {
                                e.remove()
                ...
                function v(e, t, r) {
                    if (!(F = h(e)) || 0 === F.length) return void(F = void 0);
                    a(F) ? X = setTimeout(function () {
                        f(S, M, F)
                    }, 80) : f(S, M, F)
                }
                ...
                function w() {
                    q ? g() : F && !B ? (clearTimeout(X), f(S, M, F), setTimeout(g, 0)) : g()
                }
                ...
                function y(s) {
                    ...
                    r.device.android && o(s.target) && document.activeElement.blur(), O = !0, E = s.target, I = (new Date).getTime(), S = s.targetTouches[0].pageX, M = s.targetTouches[0].pageY, r.device.ios && (D = void 0, i(E).parents().each(function () {
                        var e = this;
                        e.scrollHeight > e.offsetHeight && !D && (D = e, D.f7ScrollTop = D.scrollTop)
                    })), s.timeStamp - z < r.params.fastClicksDelayBetweenClicks && s.preventDefault(), r.params.activeState && (H = e(E), a(H) ? R = setTimeout(t, 80) : t()), r.params.material && r.params.materialRipple && v(E, S, M)
                }
                ...
                function T(e) {
                    ...
                    if (L || e.preventDefault(), e.timeStamp - z < r.params.fastClicksDelayBetweenClicks) return setTimeout(n, 0), !0;
                    if (z = e.timeStamp, O = !1, r.device.ios && D && D.scrollTop !== D.f7ScrollTop) return !1;
                ...
                var S, M, I, E, O, L, D, z, B, N, A, H, R, V, Y, q, F, W, X;
            ...
            r.getSize = function () {
                ...
                function e(e) {
                    var a = i(this),
                        t = a.attr("type");
                    if (!(r.indexOf(t) >= 0)) {
                        a.add(a.parents(".item-input, .input-field")).add(a.parents(".item-inner").eq(0)).removeClass("not-empty-state").addClass("focus-state")
                    }
                }
                    ...
                    return o.popup = void 0, o.dropdown = void 0, o.positionDropDown = function () {
                        ...
                        if (o.page = i(n.container), o.pageData = n, n.name === f) {
                            ...
                            o.searchbar = l, !o.params.multiple && o.params.backOnSelect && s.once("click", ".list-block label", function () {
                                ...
                                var e, a, r, n, s = this,
                                    l = s.value,
                                    p = (i(s).parents("li").find(".item-title").text(), i(s).parents(".autocomplete-values").length > 0);
                                if (p) {
            ...
            var b = function (e) {
                ...
                return p.setValue = function (e, a) {
                    ...
                    function n(e) {
                        y || C || (e.preventDefault(), C = !0, x = T = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, k = (new Date).getTime(), D = !0, S = I = i.getTranslate(u.wrapper[0], "y"))
                    }

                    function s(e) {
                        if (C) {
                            e.preventDefault(), D = !1, T = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, y || (i.cancelAnimationFrame(w), y = !0, S = I = i.getTranslate(u.wrapper[0], "y"), u.wrapper.transition(0));
                            I = S + (T - x), M = void 0, I < v && (I = v - Math.pow(v - I, .8), M = "min"), I > b && (I = b + Math.pow(I - b, .8), M = "max"), u.wrapper.transform("translate3d(0," + I + "px,0)"), u.updateItems(void 0, I, 0, p.params.updateValuesOnTouchmove), O = I - E || I, L = (new Date).getTime(), E = I
                        }
                    }
                    ...
                    if (!u.divider) {
                        ...
                        var C, y, x, T, k, P, S, M, I, E, O, L, D = !0;
                ...
                return p.animating = !1, p.addValue = function (e) {
                    ...
                    function a(e) {
                        if (s) {
                            ...
                            T = !1, o || (o = !0, b = p.wrapper[0].offsetWidth, w = p.wrapper[0].offsetHeight, p.wrapper.transition(0)), y = p.isH ? c - l : u - d, C = y / (p.isH ? b : w), v = 100 * (p.monthsTranslate * m + C), p.wrapper.transform("translate3d(" + (p.isH ? v : 0) + "%, " + (p.isH ? 0 : v) + "%, 0)")
                        }
                    }

                    function t(e) {
                        if (!s || !o) return void(s = o = !1);
                        s = o = !1, f = (new Date).getTime(),
                            f - h < 300 ? Math.abs(y) < 10 ? p.resetMonth() : y >= 10 ? r.rtl ? p.nextMonth() : p.prevMonth() : r.rtl ? p.prevMonth() : p.nextMonth() : C <= -.5 ? r.rtl ? p.prevMonth() : p.nextMonth() : C >= .5 ? r.rtl ? p.nextMonth() : p.prevMonth() : p.resetMonth(), setTimeout(function () {
                                T = !0
                            }, 100)
                    }
                    ...
                    var t = e.getFullYear(),
                        r = e.getMonth();
                    e.getDate();
                    "next" === a && (e = 11 === r ? new Date(t + 1, 0) : new Date(t, r + 1, 1)), "prev" === a && (e = 0 === r ? new Date(t - 1, 11) : new Date(t, r - 1, 1)), "next" !== a && "prev" !== a || (r = e.getMonth(), t = e.getFullYear());
            ...
            r.addNotification = function (e) {
                ...
                e.on("change", '.checkbox-cell input[type="checkbox"]', function (r) {
                    ...
                    var a, t = i(this),
                        r = t.hasClass("sortable-active");
                    r ? (a = t.hasClass("sortable-desc") ? "desc" : "asc", t.removeClass("sortable-desc sortable-asc").addClass("sortable-" + ("desc" === a ? "asc" : "desc"))) : (e.find("thead .sortable-active").removeClass("sortable-active"), t.addClass("sortable-active"))
        ...
        }, Framework7.$ = window.Dom7, Framework7.prototype.support = function () {
            return {
        ...
        }(), Framework7.prototype.plugins = {}, window.Swiper = function (e, a) {
            function t(e) {
                return Math.floor(e)
            }
            ...
            var d = {};
            for (var c in a)
                if ("object" != typeof a[c] || null === a[c] || (a[c].nodeType || a[c] === window || a[c] === document || "undefined" != typeof Dom7 && a[c] instanceof Dom7 || "undefined" != typeof jQuery && a[c] instanceof jQuery)) d[c] = a[c];
                else {
                    d[c] = {};
            ...
            var g = g;
            if (void 0 !== g && "undefined" != typeof Dom7 && (g = Dom7), (void 0 !== g || (g = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (f.$ = g, f.currentBreakpoint = void 0, f.getActiveBreakpoint = function () {
                ...
                f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push(f.params.containerModifierClass + f.params.direction), f.params.freeMode && f.classNames.push(f.params.containerModifierClass + "free-mode"), f.support.flexbox || (f.classNames.push(f.params.containerModifierClass + "no-flexbox"), f.params.slidesPerColumn = 1), f.params.autoHeight && f.classNames.push(f.params.containerModifierClass + "autoheight"), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), f.params.touchReleaseOnEdges && (f.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push(f.params.containerModifierClass + "3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push(f.params.containerModifierClass + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0), "fade" !== f.params.effect && "flip" !== f.params.effect || (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, void 0 === p && (f.params.virtualTranslate = !0)),
                    f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = g(f.params.pagination), f.params.uniqueNavElements && "string" == typeof f.params.pagination && f.paginationContainer.length > 1 && 1 === f.container.find(f.params.pagination).length && (f.paginationContainer = f.container.find(f.params.pagination)), "bullets" === f.params.paginationType && f.params.paginationClickable ? f.paginationContainer.addClass(f.params.paginationModifierClass + "clickable") : f.params.paginationClickable = !1, f.paginationContainer.addClass(f.params.paginationModifierClass + f.params.paginationType)), (f.params.nextButton || f.params.prevButton) && (f.params.nextButton && (f.nextButton = g(f.params.nextButton), f.params.uniqueNavElements && "string" == typeof f.params.nextButton && f.nextButton.length > 1 && 1 === f.container.find(f.params.nextButton).length && (f.nextButton = f.container.find(f.params.nextButton))), f.params.prevButton && (f.prevButton = g(f.params.prevButton), f.params.uniqueNavElements && "string" == typeof f.params.prevButton && f.prevButton.length > 1 && 1 === f.container.find(f.params.prevButton).length && (f.prevButton = f.container.find(f.params.prevButton)))), f.isHorizontal = function () {
                        ...
                        if (f) {
                            ...
                            var t;
                            if (e) {
                                f.controller && f.controller.spline && (f.controller.spline = void 0), f.params.freeMode ? (a(), f.params.autoHeight && f.updateAutoHeight()) : (("auto" === f.params.slidesPerView || f.params.slidesPerView > 1) && f.isEnd && !f.params.centeredSlides ? f.slideTo(f.slides.length - 1, 0, !1, !0) : f.slideTo(f.activeIndex, 0, !1, !0)) || a()
                ...
                f.onTouchStart = function (e) {
                    if (e.originalEvent && (e = e.originalEvent), (L = "touchstart" === e.type) || !("which" in e) || 3 !== e.which) {
                        ...
                        if (!f.params.swipeHandler || n(e, f.params.swipeHandler)) {
                            ...
                            if (!(f.device.ios && f.params.iOSEdgeSwipeDetection && a <= f.params.iOSEdgeSwipeThreshold)) {
                                if (b = !0, w = !1, C = !0, x = void 0, D = void 0, f.touches.startX = a, f.touches.startY = t, y = Date.now(), f.allowClick = !0, f.updateContainerSize(), f.swipeDirection = void 0, f.params.threshold > 0 && (P = !1), "touchstart" !== e.type) {
                                    var r = !0;
                    ...
                    if (e.originalEvent && (e = e.originalEvent), !L || "mousemove" !== e.type) {
                        ...
                        if (C && f.emit("onTouchMove", f, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                            ...
                            if (x && f.emit("onTouchMoveOpposite", f, e), void 0 === D && (f.touches.currentX === f.touches.startX && f.touches.currentY === f.touches.startY || (D = !0)), b) {
                    ...
                    f.animating = !1, f.setWrapperTransition(0), void 0 === e && (e = !0), f.lazy && f.lazy.onTransitionEnd(),
                        e && (f.emit("onTransitionEnd", f), f.activeIndex !== f.previousIndex && (f.emit("onSlideChangeEnd", f), f.activeIndex > f.previousIndex ? f.emit("onSlideNextEnd", f) : f.emit("onSlidePrevEnd", f))), f.params.history && f.history && f.history.setHistory(f.params.history, f.activeIndex), f.params.hashnav && f.hashnav && f.hashnav.setHash()
                    ...
                    coverflow: {
                        setTranslate: function () {
                            ...
                            if (f.browser.ie) {
                                f.wrapper[0].style.perspectiveOrigin = a + "px 50%"
                            }
                        },
                        setTransition: function (e) {
                ...
                for (var z in f.plugins) {
                    var B = f.plugins[z](f, f.params[z]);
                    B && f._plugins.push(B)
                }
