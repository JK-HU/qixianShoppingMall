<?php /*a:3:{s:72:"/andx/wwwroot/qixian_wuyiyizhan_com/application/admin/view/ad/index.html";i:1556506849;s:75:"/andx/wwwroot/qixian_wuyiyizhan_com/application/admin/view/common/head.html";i:1556015467;s:75:"/andx/wwwroot/qixian_wuyiyizhan_com/application/admin/view/common/foot.html";i:1556015467;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="demoTable">
        ...
        <div class="layui-inline">
            <select name="type_id"  id="type_id" lay-verify="required" lay-filter="type_id" class="layui-input">
                ...
                <option value="<?php echo htmlentities($vo['type_id']); ?>"><?php echo htmlentities($vo['name']); ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
        <button class="layui-btn" id="search" data-type="reload"><?php echo lang('search'); ?></button>
        <a href="<?php echo url('index'); ?>" class="layui-btn">刷新页面</a>
    ...
    layui.use(['table','form'], function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                {title: '<?php echo lang("action"); ?>', width: 160, align: 'center', toolbar: '#action'}
            ]],
            limit:10
        });
